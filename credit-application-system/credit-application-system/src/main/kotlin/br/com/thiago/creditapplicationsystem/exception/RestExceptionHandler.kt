...
//CLASSE QUE IRÁ ESCUTAR AS EXCEPTIONS E IRÁ TRATAR

@RestControllerAdvice // anotação que tem os métodos de exceptions para tratar
class RestExceptionHandler {
    ...
    //Tratamento desenvolvido por nós
